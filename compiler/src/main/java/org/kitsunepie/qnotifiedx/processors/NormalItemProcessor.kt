package org.kitsunepie.qnotifiedx.processors
...
@SupportedAnnotationTypes("org.kitsunepie.qnotifiedx.annotations.NormalHookEntry")
...
class NormalItemProcessor : BaseProcessor() {
    ...
    override fun process(annotations: Set<TypeElement?>?, roundEnv: RoundEnvironment): Boolean {
        ...
        val elems =
            roundEnv.getElementsAnnotatedWith(org.kitsunepie.qnotifiedx.annotations.NormalHookEntry::class.java)
        if (elems.isEmpty()) {
            println(">>>> NormalItemProcessor skipped because empty <<<<")
            return false
        }
        val hook = ClassName("org.kitsunepie.qnotifiedx.app.hook.base", "BaseNormalHook")
        ...
        val file = FileSpec.builder("org.kitsunepie.qnotifiedx.gen", "AnnotatedNormalItemList")
            .addType(
