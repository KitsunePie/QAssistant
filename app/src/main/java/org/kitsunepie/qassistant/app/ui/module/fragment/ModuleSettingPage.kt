...
val moduleSettingFragment: UiScreen = uiScreen {
    name = resources.getString(R.string.module_other_setting_module)
    summary = null
    contains = linkedMapOf(
        uiCategory {
            name = resources.getString(R.string.module_other_setting_module_startup)
            contains = linkedMapOf(
                uiSwitchItem {
                    title =
                        resources.getString(R.string.module_other_setting_module_startup_toast)
